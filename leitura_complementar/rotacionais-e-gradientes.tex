...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/4edf476308f0b5a8649586320674ef65e4020ad6.png}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./.ob-jupyter/cbf904adf44fd782d970be8c5bb5abc08d26473b.png}
\end{center}
De tal modo que \(\nabla\times A=0\):
\begin{verbatim}
curl(A,S)
